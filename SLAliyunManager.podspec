...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SLAliyunManager.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/chenjm/SLAliyunManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'chenjm' => 'chenjm2@adnonstop.com' }
  s.source           = { :git => 'https://github.com/chenjm/SLAliyunManager.git', :tag => s.version.to_s }
